...
@Configuration
@EnableJpaRepositories(basePackages = "br.com.ag.boot", 
...
public class JpaConfig {
	...
	public DataSource getDataSource() {
		...
		ds.setJdbcUrl("jdbc:postgresql://localhost:5432/todo");
		ds.setUsername("ilion");
		ds.setPassword("2pnbCMUn");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		factoryBean.setPackagesToScan(new String[] {"br.com.ag.boot.model"});
